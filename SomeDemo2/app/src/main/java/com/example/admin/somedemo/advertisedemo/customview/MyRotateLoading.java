...
public class MyRotateLoading extends View {
    ...
    public MyRotateLoading(Context context) {
        super(context);
        initView(context, null);
    }

    public MyRotateLoading(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public MyRotateLoading(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
//                TypedArray typedArray = context.obtainStyledAttributes(attrs, com.victor.loading.R.styleable.RotateLoading);
//                color = typedArray.getColor(com.victor.loading.R.styleable.RotateLoading_loading_color, Color.WHITE);
            color = Color.WHITE;
//                width = typedArray.getDimensionPixelSize(com.victor.loading.R.styleable.RotateLoading_loading_width, dpToPx(context, DEFAULT_WIDTH));
            width = dpToPx(context, DEFAULT_WIDTH);
//                shadowPosition = typedArray.getInt(com.victor.loading.R.styleable.RotateLoading_shadow_position, DEFAULT_SHADOW_POSITION);
            shadowPosition = DEFAULT_SHADOW_POSITION;
//                speedOfDegree = typedArray.getInt(com.victor.loading.R.styleable.RotateLoading_loading_speed, DEFAULT_SPEED_OF_DEGREE);
            speedOfDegree = DEFAULT_SPEED_OF_DEGREE;
//                typedArray.recycle();
        }
