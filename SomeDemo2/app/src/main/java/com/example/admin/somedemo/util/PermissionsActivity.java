...
import com.example.admin.somedemo.MainActivity;
...
public class PermissionsActivity extends Activity {
    ...
    private void handlePermissionsFailure() {
        new AlertDialog.Builder(this).setTitle("Camera error")
                .setMessage("The app does not have critical permissions needed to run. Please check your permissions settings.")
